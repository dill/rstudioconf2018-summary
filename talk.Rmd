...
- SO MANY UNREADABLE SLIDES (kinda like this presentation?)
- Mostly (70%) men (also like this presentation)
---
...
- Can support "practical significance" 
  - with large datasets, statistical significance (p < 0.05) is possible with very small effects sizes (e.g., c-section babies in Australia)
...
# Spatial data with `sf` (Pebesma)

- `sp` is a *pain*
- `sf` ("simple features") is the next gen of `sp`
- there are 17 simple features, including points, lines, and polygons
